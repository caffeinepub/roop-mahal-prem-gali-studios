...
export class Backend implements backendInterface {
    ...
    async addProject(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
    ...
    async updateProject(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
